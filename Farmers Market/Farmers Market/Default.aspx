                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <asp:PlaceHolder ID="paneFlagBody" runat="server">
                            ...
                            <asp:Button ID="btnReportGood" type="button" class="btn btn-success btn-rounded m-3" runat="server" Text="Flag as edible" OnClick="btnReportGood_Click" />
                            <asp:Button ID="btnReportBad" type="button" class="btn btn-danger btn-rounded m-3" runat="server" Text="Flag as inedible" OnClick="btnReportBad_Click" />
                        </asp:PlaceHolder>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-mdb-dismiss="modal">Close</button>
